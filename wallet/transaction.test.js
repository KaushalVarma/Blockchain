...
describe('Transaction', () => {
  ...
  beforeEach(() => {
    ...
    recipient = 'recipient-public-key';
        amount = 50; //wallets default balance is 1000
        ...
        describe('when the transaction is invalid', ()=>{
            describe('and a transaction outputMap value is invalid', ()=>{
                it('returns false and logs an error', () =>{
                    transaction.outputMap[senderWallet.publicKey] = 999999; //Corrupting the values with invalid data
            ...
            describe('and the transaction input signature is invalid', ()=>{
                it('returns false and logs an error', () =>{
                transaction.input.signature = new Wallet().sign('data');//Corrupting the values with invalid data
                    expect(Transaction.validTransaction(transaction)).toBe(false);
                    expect(errorMock).toHaveBeenCalled();
                });
            });
